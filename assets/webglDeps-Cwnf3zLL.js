import{E as _,o as g}from"./VertexArrayObject-DDS5iwUG.js";import{x as j,s as F}from"./FramebufferObject-CefdoG5Q.js";import{r as c}from"./ProgramTemplate-DZtGJo3r.js";import{e as O,a as P}from"./ProgramTemplate-DZtGJo3r.js";import{J as A}from"./index-BK4NQ6A4.js";import{t as p}from"./NestedMap-GuqgquCN.js";import"./memoryEstimations-Dnq1bqq3.js";class d{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function x(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
...
`}}return e}export{_ as BufferObject,j as FramebufferObject,c as Program,d as ProgramCache,F as Renderbuffer,O as ShaderCompiler,A as Texture,g as VertexArrayObject,P as createProgram,x as glslifyDefineMap};
