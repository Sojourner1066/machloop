import{hI as We,hK as et,jP as Bt,eQ as k,U as x,eT as Je,W as Me,sL as kt,eS as H,eA as xe,H as Ht,aB as X,d$ as Gt,dw as tt,hu as Jt,cW as Yt,a0 as S,od as Zt,al as Xt,jG as qt,_ as Qt,bI as it,nY as Te,bE as Ie,ab as Et,o7 as Kt,oa as se,ey as ue,an as rt,eB as Pe,eO as ei,np as ti,hT as ii,be as ri,ea as Ve,c5 as ai,A as si,f7 as ni,sS as oi}from"./index-BCSVvjKE.js";import{t as li}from"./orientedBoundingBox-_rBUPh5x.js";import{b2 as At,l as Ye,b3 as ci,b4 as di,I as Rt,J as xt,K as Ct,L as T,e as Z,aH as _e,b5 as at,u as pi,c as ui,g as Ze,w as Xe,C as hi,z as Be,aw as fi,v as mi,r as vi,a as gi,aT as Si,ar as Ti,o as _i,ai as bi,aG as Oi,x as yi,B as he,F as Ei,G as Ai,E as st,b6 as Ri,aN as nt,aO as xi,aP as ot,H as Ci,aJ as Di,aK as Li,aL as Ii,b7 as Pi,b8 as lt,b9 as $i,ba as wi,bb as Ni,O as B,M as Ui,X as ae,Y as ke,b0 as zi,b1 as Fi,f as ji}from"./Geometry-CHQYtKrq.js";import{o as Wi,e as Re}from"./mat4f64-Dk4dwAN8.js";import{U as ct,E as Mi}from"./sphere-DRB5B-QR.js";import{m as Vi,p as be,M as De,V as M,O as dt}from"./plane-gAgGBHhk.js";import{t as Bi}from"./basicInterfaces-CZwQPxTp.js";import{s as ki,m as Hi,H as Gi}from"./InterleavedLayout-hEsKBZ7L.js";import{E as Ji,e as u}from"./VertexAttribute-Cq4MnHjR.js";import{e as Yi,r as Zi,t as Xi,a as Dt}from"./dehydratedFeatureUtils-CRr7ZGGS.js";import{b as qi,j as Oe}from"./Octree-BPpZKQ9G.js";import{M as Qi,b as $e,v as Lt,B as Ki}from"./lineSegment-BFjWctde.js";import{n as ne,u as pe,i as er,S as tr,C as pt,e as ir}from"./ShaderOutput-DnYY5J1_.js";import{B as ye,g as we,c as ut}from"./renderState-DUM9wQon.js";import{m as rr}from"./computeTranslationToOriginAndRotation-BKUgOs_N.js";import{u as ar}from"./hydratedFeatures-DhDTqLyY.js";import{n as p,t as sr}from"./glsl-BH37Aalp.js";import"./BindType-BBwFZqyN.js";import"./floatRGBA-CFy-2SA-.js";import{i as nr}from"./ShaderBuilder-4Epc3uLW.js";var ht,ft,mt;(function(t){t[t.RasterImage=0]="RasterImage",t[t.Features=1]="Features"})(ht||(ht={})),function(t){t[t.MapLayer=0]="MapLayer",t[t.ViewLayer=1]="ViewLayer",t[t.Outline=2]="Outline",t[t.SnappingHint=3]="SnappingHint"}(ft||(ft={})),function(t){t[t.WithRasterImage=0]="WithRasterImage",t[t.WithoutRasterImage=1]="WithoutRasterImage"}(mt||(mt={}));var Ce;(function(t){t[t.ASYNC=0]="ASYNC",t[t.SYNC=1]="SYNC"})(Ce||(Ce={}));let or=class extends At{get geometries(){return this._geometries}get transformation(){return this._transformation??Wi}set transformation(e){this._transformation=We(this._transformation??Re(),e),this._invalidateBoundingVolume(),this._emit("transformationChanged",this)}get shaderTransformation(){return this._shaderTransformation}set shaderTransformation(e){this._shaderTransformation=e?We(this._shaderTransformation??Re(),e):null,this._invalidateBoundingVolume(),this._emit("shaderTransformationChanged",this)}get effectiveTransformation(){return this.shaderTransformation??this.transformation}constructor(e={}){super(),this.type=Ye.Object,this._shaderTransformation=null,this._parentLayer=null,this._visible=!0,this.castShadow=e.castShadow??!0,this.usesVerticalDistanceToGround=e.usesVerticalDistanceToGround??!1,this.graphicUid=e.graphicUid,this.layerUid=e.layerUid,e.isElevationSource&&(this.lastValidElevationBB=new It),this._geometries=e.geometries?Array.from(e.geometries):new Array}dispose(){this._geometries.length=0}get parentLayer(){return this._parentLayer}set parentLayer(e){ki(this._parentLayer==null||e==null,"Object3D can only be added to a single Layer"),this._parentLayer=e}addGeometry(e){e.visible=this._visible,this._geometries.push(e),this._emit("geometryAdded",{object:this,geometry:e}),this._invalidateBoundingVolume()}removeGeometry(e){const i=this._geometries.splice(e,1)[0];i&&(this._emit("geometryRemoved",{object:this,geometry:i}),this._invalidateBoundingVolume())}removeAllGeometries(){for(;this._geometries.length>0;)this.removeGeometry(0)}geometryVertexAttributeUpdated(e,i,r=!1){this._emit("attributesChanged",{object:this,geometry:e,attribute:i,sync:r}),Ji(i)&&this._invalidateBoundingVolume()}get visible(){return this._visible}set visible(e){if(this._visible!==e){this._visible=e;for(const i of this._geometries)i.visible=this._visible;this._emit("visibilityChanged",this)}}maskOccludee(){const e=new ci;for(const i of this._geometries)i.occludees=Yi(i.occludees,e);return this._emit("occlusionChanged",this),e}removeOcclude(e){for(const i of this._geometries)i.occludees=Zi(i.occludees,e);this._emit("occlusionChanged",this)}highlight(e){const i=new di(e);for(const r of this._geometries)r.addHighlight(i);return this._emit("highlightChanged",this),i}removeHighlight(e){for(const i of this._geometries)i.removeHighlight(e);this._emit("highlightChanged",this)}removeStateID(e){e.channel===Bi.Highlight?this.removeHighlight(e):this.removeOcclude(e)}getCombinedStaticTransformation(e,i){return et(i,this.transformation,e.transformation)}getCombinedShaderTransformation(e,i=Re()){return et(i,this.effectiveTransformation,e.transformation)}get boundingVolumeWorldSpace(){return this._bvWorldSpace||(this._bvWorldSpace=this._bvWorldSpace||new vt,this._validateBoundingVolume(this._bvWorldSpace,fe.WorldSpace)),this._bvWorldSpace}get boundingVolumeObjectSpace(){return this._bvObjectSpace||(this._bvObjectSpace=this._bvObjectSpace||new vt,this._validateBoundingVolume(this._bvObjectSpace,fe.ObjectSpace)),this._bvObjectSpace}_validateBoundingVolume(e,i){const r=i===fe.ObjectSpace;for(const a of this._geometries){const s=a.boundingInfo;s&&lr(s,e,r?a.transformation:this.getCombinedShaderTransformation(a))}Bt(ct(e.bounds),e.min,e.max,.5);for(const a of this._geometries){const s=a.boundingInfo;if(s==null)continue;const l=r?a.transformation:this.getCombinedShaderTransformation(a),o=Vi(l);k(gt,s.center,l);const n=Je(gt,ct(e.bounds)),c=s.radius*o;e.bounds[3]=Math.max(e.bounds[3],n+c)}}_invalidateBoundingVolume(){var i;const e=(i=this._bvWorldSpace)==null?void 0:i.bounds;this._bvObjectSpace=this._bvWorldSpace=void 0,this._parentLayer&&e&&this._parentLayer.notifyObjectBBChanged(this,e)}_emit(e,i){this._parentLayer&&this._parentLayer.events.emit(e,i)}get test(){}};class It{constructor(){this.min=Me(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),this.max=Me(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE)}isEmpty(){return this.max[0]<this.min[0]&&this.max[1]<this.min[1]&&this.max[2]<this.min[2]}}class vt extends It{constructor(){super(...arguments),this.bounds=Mi()}}function lr(t,e,i){const r=t.bbMin,a=t.bbMax;if(kt(i)){const s=H(cr,i[12],i[13],i[14]);xe(z,r,s),xe(j,a,s);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l]),e.max[l]=Math.max(e.max[l],j[l])}else if(k(z,r,i),Ht(r,a))for(let s=0;s<3;++s)e.min[s]=Math.min(e.min[s],z[s]),e.max[s]=Math.max(e.max[s],z[s]);else{k(j,a,i);for(let s=0;s<3;++s)e.min[s]=Math.min(e.min[s],z[s],j[s]),e.max[s]=Math.max(e.max[s],z[s],j[s]);for(let s=0;s<3;++s){X(z,r),X(j,a),z[s]=a[s],j[s]=r[s],k(z,z,i),k(j,j,i);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l],j[l]),e.max[l]=Math.max(e.max[l],z[l],j[l])}}}const cr=x(),z=x(),j=x(),gt=x();var fe;(function(t){t[t.WorldSpace=0]="WorldSpace",t[t.ObjectSpace=1]="ObjectSpace"})(fe||(fe={}));const dr=["layerObjectAdded","layerObjectRemoved","layerObjectsAdded","layerObjectsRemoved","transformationChanged","shaderTransformationChanged","visibilityChanged","occlusionChanged","highlightChanged","geometryAdded","geometryRemoved","attributesChanged"];let pr=class extends At{constructor(e,i,r=""){super(),this.stage=e,this.apiLayerUid=r,this.type=Ye.Layer,this.events=new Gt,this.visible=!0,this.sliceable=!1,this._objectsAdded=new tt,this._handles=new Jt,this._objects=new tt,this._pickable=!0,this.visible=(i==null?void 0:i.visible)??!0,this._pickable=(i==null?void 0:i.pickable)??!0,this.updatePolicy=(i==null?void 0:i.updatePolicy)??Ce.ASYNC,this._disableOctree=(i==null?void 0:i.disableOctree)??!1,e.add(this);for(const a of dr)this._handles.add(this.events.on(a,s=>e.handleEvent(a,s)))}destroy(){this._handles.size&&(this._handles.destroy(),this.stage.remove(this),this.invalidateSpatialQueryAccelerator())}get objects(){return this._objects}set pickable(e){this._pickable=e}get pickable(){return this._pickable&&this.visible}add(e){this._objects.push(e),e.parentLayer=this,this.events.emit("layerObjectAdded",{layer:this,object:e}),this._octree!=null&&this._objectsAdded.push(e)}remove(e){this._objects.removeUnordered(e)&&(e.parentLayer=null,this.events.emit("layerObjectRemoved",{layer:this,object:e}),this._octree!=null&&(this._objectsAdded.removeUnordered(e)||this._octree.remove([e])))}addMany(e){this._objects.pushArray(e);for(const i of e)i.parentLayer=this;this.events.emit("layerObjectsAdded",{layer:this,objects:e}),this._octree!=null&&this._objectsAdded.pushArray(e)}removeMany(e){const i=new Array;if(this._objects.removeUnorderedMany(e,e.length,i),i.length!==0){for(const r of i)r.parentLayer=null;if(this.events.emit("layerObjectsRemoved",{layer:this,objects:i}),this._octree!=null){for(let r=0;r<i.length;)this._objectsAdded.removeUnordered(i[r])?(i[r]=i[i.length-1],i.length-=1):++r;this._octree.remove(i)}}}sync(){this.updatePolicy!==Ce.SYNC&&this.stage.syncLayer(this.id)}notifyObjectBBChanged(e,i){this._octree==null||this._objectsAdded.includes(e)||this._octree.update(e,i)}getSpatialQueryAccelerator(){return this._octree==null&&this._objects.length>50&&!this._disableOctree?(this._octree=new qi(e=>e.boundingVolumeWorldSpace.bounds),this._octree.add(this._objects.data,this._objects.length)):this._octree!=null&&this._objectsAdded.length>0&&(this._octree.add(this._objectsAdded.data,this._objectsAdded.length),this._objectsAdded.clear()),this._octree}invalidateSpatialQueryAccelerator(){this._octree=Yt(this._octree),this._objectsAdded.clear()}},ur=class{constructor(e,i){this.vec3=e,this.id=i}};function St(t,e,i,r){return new ur(Me(t,e,i),r)}var te,me;(function(t){t[t.Draped=0]="Draped",t[t.Screen=1]="Screen",t[t.World=2]="World",t[t.COUNT=3]="COUNT"})(te||(te={})),function(t){t[t.Center=0]="Center",t[t.Tip=1]="Tip",t[t.COUNT=2]="COUNT"}(me||(me={}));let F=class extends Rt{constructor(){super(...arguments),this.space=te.Screen,this.anchor=me.Center,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.vvSize=!1,this.vvColor=!1,this.vvOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.textureCoordinateType=xt.None,this.emissionSource=Ct.None,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVvInstancing=!0,this.hasSliceTranslatedView=!0,this.objectAndLayerIdColorInstanced=!1}get draped(){return this.space===te.Draped}};S([T({count:te.COUNT})],F.prototype,"space",void 0),S([T({count:me.COUNT})],F.prototype,"anchor",void 0),S([T()],F.prototype,"occluder",void 0),S([T()],F.prototype,"writeDepth",void 0),S([T()],F.prototype,"hideOnShortSegments",void 0),S([T()],F.prototype,"hasCap",void 0),S([T()],F.prototype,"hasTip",void 0),S([T()],F.prototype,"vvSize",void 0),S([T()],F.prototype,"vvColor",void 0),S([T()],F.prototype,"vvOpacity",void 0),S([T()],F.prototype,"hasOccludees",void 0),S([T()],F.prototype,"terrainDepthTest",void 0),S([T()],F.prototype,"cullAboveTerrain",void 0);const Tt=8;function hr(t,e){const i=t.vertex;i.uniforms.add(new Z("intrinsicWidth",r=>r.width)),e.vvSize?(t.attributes.add(u.SIZEFEATUREATTRIBUTE,"float"),i.uniforms.add(new _e("vvSizeMinSize",r=>r.vvSize.minSize),new _e("vvSizeMaxSize",r=>r.vvSize.maxSize),new _e("vvSizeOffset",r=>r.vvSize.offset),new _e("vvSizeFactor",r=>r.vvSize.factor)),i.code.add(p`float getSize() {
return intrinsicWidth * clamp(vvSizeOffset + sizeFeatureAttribute * vvSizeFactor, vvSizeMinSize, vvSizeMaxSize).x;
}`)):(t.attributes.add(u.SIZE,"float"),i.code.add(p`float getSize(){
return intrinsicWidth * size;
}`)),e.vvOpacity?(t.attributes.add(u.OPACITYFEATUREATTRIBUTE,"float"),i.constants.add("vvOpacityNumber","int",8),i.uniforms.add(new at("vvOpacityValues",r=>r.vvOpacity.values,Tt),new at("vvOpacityOpacities",r=>r.vvOpacity.opacityValues,Tt)),i.code.add(p`float interpolateOpacity( float value ){
...
}`))}function Pt(t){return t.pattern.map(e=>Math.round(e*t.pixelRatio))}function fr(t){if(t==null)return 1;const e=Pt(t);return Math.floor(e.reduce((i,r)=>i+r))}function mr(t){return Pt(t).reduce((e,i)=>Math.max(e,i))}function vr(t){return t==null?Zt:t.length===4?t:Xt(gr,t[0],t[1],t[2],1)}const gr=qt();function Sr(t,e){if(!e.stippleEnabled)return void t.fragment.code.add(p`float getStippleAlpha() { return 1.0; }
void discardByStippleAlpha(float stippleAlpha, float threshold) {}
vec4 blendStipple(vec4 color, float stippleAlpha) { return color; }`);const i=!(e.draped&&e.stipplePreferContinuous),{vertex:r,fragment:a}=t;a.include(Xi),e.draped||(ui(r,e),r.uniforms.add(new Ze("worldToScreenPerDistanceRatio",({camera:s})=>1/s.perScreenPixelRatio)).code.add(p`float computeWorldToScreenRatio(vec3 segmentCenter) {
...
}`),a.uniforms.add(new hi("stipplePatternTexture",s=>s.stippleTexture),new Z("stipplePatternSDFNormalizer",s=>Tr(s.stipplePattern)),new Z("stipplePatternPixelSizeInv",s=>1/$t(s))),e.stippleOffColorEnabled&&a.uniforms.add(new Be("stippleOffColor",s=>vr(s.stippleOffColor))),a.code.add(p`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Tr(t){return t?(Math.floor(.5*(mr(t)-1))+.5)/t.pixelRatio:1}function $t(t){const e=t.stipplePattern;return e?fr(t.stipplePattern)/e.pixelRatio:1}const _r=.4,wt=64,br=wt/2,Or=br/5,yr=wt/Or,ya=.25;function Er(t,e){const i=t.vertex;Xe(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",yr).code.add(p`float getLineWidth() {
return max(getSize(), 1.0) * pixelRatio;
}
float getScreenMarkerSize() {
return markerSizePerLineWidth * markerScale * getLineWidth();
}`),e.space===te.World&&(i.constants.add("maxSegmentLengthFraction","float",.45),i.uniforms.add(new Ze("perRenderPixelRatio",r=>r.camera.perRenderPixelRatio)),i.code.add(p`bool areWorldMarkersHidden(vec4 pos, vec4 other) {
...
vReverseSegmentSDF = (isJoin && !isStartVertex) ? LARGE_HALF_FLOAT : (dot(pos.xy - segmentEnd, -segmentDir) * pos.w);`),d&&(o?a.uniforms.add(new Ze("worldToScreenRatio",v=>1/v.screenToPCSRatio)):a.main.add(p`vec3 segmentCenter = mix((nextPosition + position) * 0.5, (position + prevPosition) * 0.5, isEndVertex);
...
float segmentLengthPseudoScreen = segmentLengthRender * discreteWorldToScreenRatio;`),a.uniforms.add(new Z("stipplePatternPixelSize",v=>$t(v))),a.main.add(p`float patternLength = lineSize * stipplePatternPixelSize;
